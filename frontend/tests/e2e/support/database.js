...
Cypress.Commands.add('changeStudentStats', (academicTerm, stats, value) => {
  dbCommand(`
...
Cypress.Commands.add('changeQuestionStats', (academicTerm, stats, value) => {
  dbCommand(`
...
Cypress.Commands.add('changeQuizStats', (academicTerm, stats, value) => {
  dbCommand(`
    UPDATE quiz_stats
    SET ${stats}=${value}
    WHERE course_execution_id=(SELECT id FROM course_executions WHERE academic_term = '${academicTerm}')
...
Cypress.Commands.add('associateTeacherWithCourseExecution', (academicTerm) => {
  dbCommand(`
    INSERT INTO users_course_executions (users_id, course_executions_id) VALUES (
...
Cypress.Commands.add('cleanAll', () => {
  dbCommand(`
    ...
    DELETE FROM users_course_executions WHERE course_executions_id = (SELECT id FROM course_executions WHERE academic_term = '1st Semester 22/23');
    DELETE FROM users_course_executions WHERE course_executions_id = (SELECT id FROM course_executions WHERE academic_term = '1st Semester 19/20');

    DELETE FROM course_executions WHERE academic_term = '1st Semester 22/23';
    DELETE FROM course_executions WHERE academic_term = '1st Semester 19/20';
  `)
});
